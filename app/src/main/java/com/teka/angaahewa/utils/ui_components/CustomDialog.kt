package com.teka.angaahewa.utils.ui_components
...
import com.teka.angaahewa.ui.theme.DarkGray
...
fun CustomDialog(
    ...
    val negativeButtonColor: Color = PrimaryGreen
    val positiveButtonColor: Color = DarkGray
...
//                            authViewModel.logout()
                ...
                Icon(
                    ...
                    modifier = Modifier
                        .background(color = Color.Companion.White, shape = CircleShape)
                        .border(width = 2.dp, shape = CircleShape, color = positiveButtonColor)
                        .padding(all = 16.dp)
                        .align(alignment = Alignment.Companion.TopCenter)
                )
            }
        }
    }
